...
CREATE1 = "create table actions (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, ip varchar(20), deviceID varchar(64), operation varchar(16), devicetype varchar(10), filename varchar(128), date varchar(16), seconds varchar(16), city varchar(32), country varchar(4), created TIMESTAMP DEFAULT NOW())"
